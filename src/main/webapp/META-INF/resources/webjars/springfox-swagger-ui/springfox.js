$(function() {
  var springfox = {
    "baseUrl": function() {
      var urlMatches = /(.*)\/api-docs.*/.exec(window.location.href);
      return urlMatches[1];
    },
...
//        window.swaggerUi.api.clientAuthorizations.add(window.apiKeyName, apiKeyAuth);
        window.swaggerUi.api.clientAuthorizations.add("key", new SwaggerClient.ApiKeyAuthorization("Authorization", 'Bearer ' + key, "header"));
        log("added key " + key);
      }
    }
