...
public class AliasToBeanForListTransformer extends
AliasedTupleSubsetResultTransformer {
    ...
    public AliasToBeanForListTransformer(Class<?> resultClass) {
    ...
    private void loadSubEntities(Object root) throws HibernateException {
        try {
            for (String fieldName : subEntities.keySet()) {
                ...
                ResultTransformer subclassTransformer = new AliasToBeanForListTransformer(
                        subclass);
