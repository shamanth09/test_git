...
public class Image {
	...
	public byte[] getImageArray(Scale scale) {
		...
		try {
			...
			java.awt.Image img = originalImage.getScaledInstance(scale.width,
					scale.height, BufferedImage.SCALE_SMOOTH);
			BufferedImage bufferedImage = new BufferedImage(scale.width,
					scale.height, originalImage.getType());
