...
public class OrderSummaryServiceImpl implements OrderSummaryService {
	...
	@Autowired
	private WholesalerOrderSummaryDAO wholesalerOrderSummaryDAO;
	...
	@Override
	public OrderStatusesSummary getAliveOrderSummaryByTillDate(
			Date lastDate, User user) {
		if(user instanceof Supplier){
			return wholesalerOrderSummaryDAO.getOrderCountByStatusWise(null, null, user);
		}
		else
	...
	@Override
	public List<OrderStatusesSummary> getChunckOrderCountByStatusWise(Date fromdate,
