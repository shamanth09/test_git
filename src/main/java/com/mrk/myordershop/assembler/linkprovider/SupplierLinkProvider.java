...
import com.mrk.myordershop.apicontroller.wsaler.SupplierController;
import com.mrk.myordershop.bean.dto.CustomerFilter;
import com.mrk.myordershop.constant.Role;

public class SupplierLinkProvider {

	public static Link find(CustomerFilter filter) {
		switch (getRole()) {
		case ROLE_WSALER:
			return ControllerLinkBuilder.linkTo(
					ControllerLinkBuilder.methodOn(SupplierController.class)
