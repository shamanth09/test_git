...
/**
 * NavUtil.java Naveen Apr 7, 2015
 */
public class RetailerNavUtil {

	public static String PARAM_FIRST_TYME = "&ft=true";
	public static String PARAM_CART = "&cart";
	public static String PARAM_HOME = "&hme";
	public static String PARAM_EMPTY_ADDRESS = "&ademty";
	private static String URL_PDETAIL = "/v1/rt/account/psnldetail?";
	private static String URL_ADDADDRESS = "/v1/rt/account/address/add?";
	private static String URL_HOME = "/v1/home?";
	private static String URL_CART = "/v1/cart?";
...
//	}
	...
	public static void doApiValidate(User user)
			throws EntityDoseNotExistException {
		if (user != null) {
			if (user.getName() == null
					|| user.getName().trim().equals(""))
				throw new EntityDoseNotExistException(Address.class);
			if (user.getEmail() == null || user.getEmail().trim().equals(""))
				throw new EntityDoseNotExistException(Address.class);
			if (user.getMobile() == null || user.getMobile().trim().equals(""))
				throw new EntityDoseNotExistException(Address.class);
